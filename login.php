...
function logincheck($u, $p) {
    global $link;
    $res=mysqli_query($link,"select * from tbl_admin_kayit where username='$u' and password='$p' ");//bize gelen password ve username göre sorgu yapıtoruz
    while ($r = mysqli_fetch_array($res)) {
        return [
            'id' => $r['id'],
            'username' => $r['username'],
            ];//gelen veriyi return ediyoruz.
    }
}
...
if ( count($_POST) > 0) {
    if (isset($_POST['username']) && isset($_POST['password'])) {
        ...
        if ( $user ) {//user boş değilse.
            ...
            header('Location: http://localhost:81/student/display_books_info.php');//id ile usernamei sessiona ata ve anasayfaya git
            die;
        } else {
        ...
        <section class="login_content">
            <form name="form1" action="" method="post">
                ...
                <div>
                    ...
                    <input class="btn btn-default submit" type="submit" name="submit1" value="Giriş Yap">
                ...
                <div class="separator">
                    <p class="change_link">Siteye yeni misin?

                        <a href="registration.php"> Hesap oluştur. </a>
                    </p>
