...
<div class="login_wrapper">
    ...
    <section class="login_content" style="margin-top: -40px;">
        <form name="form1" action="" method="post">
            <h2>Kütüphaneci Kayıt Formu</h2><br>
            <div>
    ...
    <?php
        if(isset($_POST["submit1"])){
            ...
            mysqli_select_db($link,("kutuphanedb"));
            mysqli_query($link,"insert into tbl_admin_kayit values('','$_POST[ad]','$_POST[soyad]','$_POST[kullanici_adi]','$_POST[sifre]','$_POST[email]','$_POST[tel]')");
        ?>
