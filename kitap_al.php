				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							...
							$sql="select tbl_kitap.id as tblkitap_id, tbl_kitap.*,personel_kayit.*,kitap_personel.kp_id from tbl_kitap INNER JOIN personel_kayit INNER JOIN kitap_personel ON kitap_personel.kitap_id=tbl_kitap.id && kitap_personel.personel_id=personel_kayit.id";
							...
							<table id="tablo" class='table table-bordered'>
								...
								while ($row=mysqli_fetch_array($res)){
									?>
									<tr>
										<td><a style="color: black" href="alindi.php?kid=<?php echo $row["tblkitap_id"]; ?>&verilecek_id=<?php echo $row["kp_id"];?>">al</a>  </td>
